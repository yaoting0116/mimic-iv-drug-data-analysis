...
def read_design_matrix() -> pd.DataFrame:
    topic_to_pickle_fname = {
        "Psychosis vs. Ischemic Stroke": "Ischemic_Stroke_join_drug_V7",
        "Psychosis vs. Ischemic Stroke eliminating sampled patients whose hospitalization may be due to cerebrovascular diseases": "Ischemic_Stroke_join_drug_V6_T_1day",
        "Psychosis vs. Hemorrhagic Stroke": "Hemorrhagic_Stroke_join_drug_V7",
        "Psychosis vs. Hemorrhagic Stroke eliminating sampled patients whose hospitalization may be due to cerebrovascular diseases": "Hemorrhagic_Stroke_join_drug_V6_T_1day",
    }
